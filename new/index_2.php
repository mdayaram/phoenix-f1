...
<!--
homesel=new Image(150,20);homesel.src="imgs/home-sel.png";
servicessel=new Image(150,20);servicessel.src="imgs/services-sel.png";
utilitiessel=new Image(150,20);utilitiessel.src="imgs/utilities-sel.png";
contactsel=new Image(150,20);contactsel.src="imgs/contact-sel.png";
home=new Image(150,20);home.src="imgs/home.png";
services=new Image(150,20);services.src="imgs/services.png";
utilities=new Image(150,20);utilities.src="imgs/utilities.png";
contact=new Image(150,20);contact.src="imgs/contact.png";
...
<table width="515" border="0" cellpadding="0" cellspacing="10">
<tr><td rowspan="1" width="8" valign="top" align="center" height="156">
<font color="#ffffff">.</font>
</td>
<td rowspan="2" width="499" valign="top" align="left">

<table width="180" align="left" hspace="15" vspace="15"><tr><td align="left">
<table width="150" border="0" cellspacing="0" cellpadding="0" align="left">
<tr><td valign="top" align="left">
<a href="index.php?page=home" onMouseOver="mouse('home','homesel','Home Page')" onMouseOut="mouse('home','home','')">
<img src="imgs/home.png" name="home" border="0" width="150" height="20">
</a>
...
<td rowspan="2" background="imgs/border.png" width="8" valign="top">
<font color="orange">.</font>
</td>
</tr>
<tr><td rowspan="1" background="imgs/border.png" width="8" valign="top">
<font color="orange">.</font>
</td></tr>
<tr><td rowspan="1" colspan="3" align="center">
<font face="times new roman" size="2">Copyright Phoenix F1 © 2005-2006</font>
</td>
</tr>
</table>
