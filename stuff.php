...
if(isset($_COOKIE['pr0n'])){
    ...
    if($_POST['edithistory']){
        ...
        $query = "UPDATE contacts SET info='$info' WHERE id='$id'";
        mysql_query($query);
        mysql_close();
        echo "Info. Updated";
        echo "$footer";
    }else if($_GET['servhistory']){
        $id=$_GET['servhistory'];
        mysql_connect(localhost,$username,$password);
        @mysql_select_db($database) or die( "Unable to connect to database");
        ...
        //$info=str_replace(">","]",$info);
        //$info=str_replace("<","[",$info);
        echo '<form action="stuff.php" method="post">
                <input type=hidden name=id value='.$id.'>
                <input type=hidden name=edithistory value=apples>
                <textarea name="info" cols=40 rows=5 value="';
        //echo $info;
        echo '"></textarea><br><input type="submit"></form>';
        echo "<br><br><br>Copy and Paste the following text to the field and then edit it.<br><br><br>";
    ...
    if($_POST['entry']=='new'){
        ...
        $query = "INSERT INTO contacts VALUES ('','$first','$last','$phone','$cell','$address','$city','$state','$zip','$email','$info')";
        ...
        $info = "<b>".$_POST['month']."/".$_POST['day']."/".$_POST['year']."</b> - ".$_POST['service']." - $".$_POST['cost']." - ".$_POST['tech']."<br>Description: ".$_POST['jobdesc']."<br>Notes: ".$_POST['notes']."<br>".$oldinfo;
    ...
    if($_GET['action']){
        ...
        if($action == 'new'){
            ...
            Performed by:  <input type='text' name='tech'><br>
            ...
            Description of Service: <br><textarea name='jobdesc' cols='40' rows='5'></textarea><br>
            Additional Notes: <br><textarea name='notes' cols='40' rows='5'></textarea><br>
            ...
            if($num==0){die ("Database is empty.");}
            for($p=0; $p<$num; $p++){
                $lastname=mysql_result($result,$p,"last");
                $idname=mysql_result($result,$p,"id");
                echo "<a href='#$idname'>$lastname ID: $idname</a><br>";
            }
            echo "<br><br><hr>";
            for($i=0; $i<$num; $i++) {
                ...
                echo "<hr><b><a name='$last'>$last</a>, <a name='$id'>$first</a></b>
                <br><b>Phone:</b> $phone
                <br><b>Cell:</b> $cell
                ...
                --------------------------------
                <br><b>Service History:</b><br><br>
                $info
                <br>
                <a href='stuff.php?servhistory=$id'>Edit Service History</a><br>
                --------------------------------
